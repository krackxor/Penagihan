"""
Belum Bayar API - Sunter Dashboard Pro (V9.3 Intelligence Sync)
Update: 2026-02-01
---------------------------------------------------------------------------
Pembaruan Strategis:
...
def get_belum_bayar():
    ...
    try:
        ...
        if search_query:
            ...
            query += " AND NOT EXISTS (SELECT 1 FROM kunjungan_petugas k WHERE k.nomen = p.nomen AND DATE(k.created_at) = DATE('now'))"
