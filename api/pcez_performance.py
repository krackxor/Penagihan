...
def register_pcez_routes(app, get_db):
    ...
    def get_full_stats():
        """Statistik Dashboard Utama dengan Proteksi Data NULL"""
        try:
            db = get_db()
            
            # Query Global: Menggunakan COALESCE untuk memastikan nilai 0 jika data kosong
            global_query = """
            SELECT 
            ...
            # Query Officer: Menghitung kinerja harian dan bulanan
            officer_query = """
            SELECT 
            ...
            # Query History: Detail aktivitas harian (ditambah kolom RKS sesuai UI)
            history_query = """
            SELECT 
            ...
            # Konversi Row ke Dict secara aman
            ...
            # Perhitungan sisa target dengan proteksi
